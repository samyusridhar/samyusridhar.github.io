...
<iframe src="https://open.spotify.com/embed/playlist/4lexbQSIJBWtJGQS3GQkUC" width="950" height="300" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
</div>
...
![Favorites Dataframe](./images/my-soundtrack_favorites-dataframe.png)
...
![Correlation Heatmap](./images/my-soundtrack_correlation-heatmap.png)
...
![Final Recommendations](./images/my-soundtrack_final-recommendations.png)
